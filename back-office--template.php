...
<body class="back-office">
  ...
  <main>
    <h2>Bienvenue dans votre espace privé <?php echo $_SESSION['user'] ?> </h2>
    ...
    foreach ($productsArray as $key => $product) { ?> 
      <div id="ficheProduit"> 
        ...
        <div id="imgProduit">
          <a href="popup.php?url=<?php echo $product['image'] ?>"><img src="<?php echo $product['image'] ?>" alt="image du produit" height=150px></a>
        </div>
      </div>
    <?php } ?>
  </main>
